...
class DeepWellEnvV2(gym.Env):
    ...
    def __init__(self):
        ...
        self.xdist2 = 0          #decided in init_states()
        self.ydist2 = 0          #decided in init_states()
        ...
        self.stateLow = np.array([ -self.xmax, -self.ymax, -self.xmax, -self.ymax,  -1., -1.,-self.xmax, -self.ymax])
        self.stateHigh = np.array([ self.xmax, self.ymax, self.xmax, self.ymax, 1., 1.,self.xmax, self.ymax])
