...
class DeepWellEnvSpher(gym.Env):
    ...
    def init_states(self):
        ...
        if self.numhazards > 0:
            ...
            self.hazard = np.array([np.random.choice(-1, 1)*self.xmax,
    ...
    def get_state(self):
        ...
        state = np.array([
                ...
                self.vert_targ_rel_ang1, self.hori_targ_rel_ang1, target_dist1,
                self.vert_targ_rel_ang2, self.hori_targ_rel_ang2, target_dist2,
                self.vert_haz_rel_ang, self.hori_haz_rel_ang, hazard_dist
            ])
        return state
